...
public class VerbalTestMenu extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c1 = db.query(KEY_CORSEN, null, null, null, null, null, null);//cv151 to cv200
        c2 = db.query(KEY_IMPSEN, null, null, null, null, null, null);//cv251 to cv300 //verbal
        c3 = db.query(KEY_THEME, null, null, null, null, null, null);//cv301 to cv322
        c4 = db.query(KEY_COMSEN, null, null, null, null, null, null);//cv323 to cv400 // verbal
        c5 = db.query(KEY_SELWORD, null, null, null, null, null, null);//cv401 to cv450
...

    {
        ...
        db.insert(KEY_CORSEN, null, cv151);
        db.insert(KEY_CORSEN, null, cv152);
        db.insert(KEY_CORSEN, null, cv153);
        db.insert(KEY_CORSEN, null, cv154);
        db.insert(KEY_CORSEN, null, cv155);
        db.insert(KEY_CORSEN, null, cv156);
        db.insert(KEY_CORSEN, null, cv157);
        db.insert(KEY_CORSEN, null, cv158);
        db.insert(KEY_CORSEN, null, cv159);
        db.insert(KEY_CORSEN, null, cv160);
        db.insert(KEY_CORSEN, null, cv161);
        db.insert(KEY_CORSEN, null, cv162);
        db.insert(KEY_CORSEN, null, cv163);
        db.insert(KEY_CORSEN, null, cv164);
        db.insert(KEY_CORSEN, null, cv165);
        db.insert(KEY_CORSEN, null, cv166);
        db.insert(KEY_CORSEN, null, cv167);
        db.insert(KEY_CORSEN, null, cv168);
        db.insert(KEY_CORSEN, null, cv169);
        db.insert(KEY_CORSEN, null, cv170);
        db.insert(KEY_CORSEN, null, cv171);
        db.insert(KEY_CORSEN, null, cv172);
        db.insert(KEY_CORSEN, null, cv173);
        db.insert(KEY_CORSEN, null, cv174);
        db.insert(KEY_CORSEN, null, cv175);
        db.insert(KEY_CORSEN, null, cv176);
        db.insert(KEY_CORSEN, null, cv177);
        db.insert(KEY_CORSEN, null, cv178);
        db.insert(KEY_CORSEN, null, cv179);
        db.insert(KEY_CORSEN, null, cv180);
        db.insert(KEY_CORSEN, null, cv181);
        db.insert(KEY_CORSEN, null, cv182);
        db.insert(KEY_CORSEN, null, cv183);
        db.insert(KEY_CORSEN, null, cv184);
        db.insert(KEY_CORSEN, null, cv185);
        db.insert(KEY_CORSEN, null, cv186);
        db.insert(KEY_CORSEN, null, cv187);
        db.insert(KEY_CORSEN, null, cv188);
        db.insert(KEY_CORSEN, null, cv189);
        db.insert(KEY_CORSEN, null, cv190);
        db.insert(KEY_CORSEN, null, cv191);
        db.insert(KEY_CORSEN, null, cv192);
        db.insert(KEY_CORSEN, null, cv193);
        db.insert(KEY_CORSEN, null, cv194);
        db.insert(KEY_CORSEN, null, cv195);
        db.insert(KEY_CORSEN, null, cv196);
        db.insert(KEY_CORSEN, null, cv197);
        db.insert(KEY_CORSEN, null, cv198);
        db.insert(KEY_CORSEN, null, cv199);
        db.insert(KEY_CORSEN, null, cv200);
        db.insert(KEY_IMPSEN, null, cv251);
        db.insert(KEY_IMPSEN, null, cv252);
        db.insert(KEY_IMPSEN, null, cv253);
        db.insert(KEY_IMPSEN, null, cv254);
        db.insert(KEY_IMPSEN, null, cv255);
        db.insert(KEY_IMPSEN, null, cv256);
        db.insert(KEY_IMPSEN, null, cv257);
        db.insert(KEY_IMPSEN, null, cv258);
        db.insert(KEY_IMPSEN, null, cv259);
        db.insert(KEY_IMPSEN, null, cv260);
        db.insert(KEY_IMPSEN, null, cv261);
        db.insert(KEY_IMPSEN, null, cv262);
        db.insert(KEY_IMPSEN, null, cv263);
        db.insert(KEY_IMPSEN, null, cv264);
        db.insert(KEY_IMPSEN, null, cv265);
        db.insert(KEY_IMPSEN, null, cv266);
        db.insert(KEY_IMPSEN, null, cv267);
        db.insert(KEY_IMPSEN, null, cv268);
        db.insert(KEY_IMPSEN, null, cv269);
        db.insert(KEY_IMPSEN, null, cv270);
        db.insert(KEY_IMPSEN, null, cv271);
        db.insert(KEY_IMPSEN, null, cv272);
        db.insert(KEY_IMPSEN, null, cv273);
        db.insert(KEY_IMPSEN, null, cv274);
        db.insert(KEY_IMPSEN, null, cv275);
        db.insert(KEY_IMPSEN, null, cv276);
        db.insert(KEY_IMPSEN, null, cv277);
        db.insert(KEY_IMPSEN, null, cv278);
        db.insert(KEY_IMPSEN, null, cv279);
        db.insert(KEY_IMPSEN, null, cv280);
        db.insert(KEY_IMPSEN, null, cv281);
        db.insert(KEY_IMPSEN, null, cv282);
        db.insert(KEY_IMPSEN, null, cv283);
        db.insert(KEY_IMPSEN, null, cv284);
        db.insert(KEY_IMPSEN, null, cv285);
        db.insert(KEY_IMPSEN, null, cv286);
        db.insert(KEY_IMPSEN, null, cv287);
        db.insert(KEY_IMPSEN, null, cv288);
        db.insert(KEY_IMPSEN, null, cv289);
        db.insert(KEY_IMPSEN, null, cv290);
        db.insert(KEY_IMPSEN, null, cv291);
        db.insert(KEY_IMPSEN, null, cv292);
        db.insert(KEY_IMPSEN, null, cv293);
        db.insert(KEY_IMPSEN, null, cv294);
        db.insert(KEY_IMPSEN, null, cv295);
        db.insert(KEY_IMPSEN, null, cv296);
        db.insert(KEY_IMPSEN, null, cv297);
        db.insert(KEY_IMPSEN, null, cv298);
        db.insert(KEY_IMPSEN, null, cv299);
        db.insert(KEY_IMPSEN, null, cv300);
        ...
        db.insert(KEY_COMSEN, null, cv323);
        db.insert(KEY_COMSEN, null, cv324);
        db.insert(KEY_COMSEN, null, cv325);
        db.insert(KEY_COMSEN, null, cv326);
        db.insert(KEY_COMSEN, null, cv327);
        db.insert(KEY_COMSEN, null, cv328);
        db.insert(KEY_COMSEN, null, cv329);
        db.insert(KEY_COMSEN, null, cv330);
        db.insert(KEY_COMSEN, null, cv331);
        db.insert(KEY_COMSEN, null, cv332);
        db.insert(KEY_COMSEN, null, cv333);
        db.insert(KEY_COMSEN, null, cv334);
        db.insert(KEY_COMSEN, null, cv335);
        db.insert(KEY_COMSEN, null, cv336);
        db.insert(KEY_COMSEN, null, cv337);
        db.insert(KEY_COMSEN, null, cv338);
        db.insert(KEY_COMSEN, null, cv339);
        db.insert(KEY_COMSEN, null, cv340);
        db.insert(KEY_COMSEN, null, cv341);
        db.insert(KEY_COMSEN, null, cv342);
        db.insert(KEY_COMSEN, null, cv343);
        db.insert(KEY_COMSEN, null, cv344);
        db.insert(KEY_COMSEN, null, cv345);
        db.insert(KEY_COMSEN, null, cv346);
        db.insert(KEY_COMSEN, null, cv347);
        db.insert(KEY_COMSEN, null, cv348);
        db.insert(KEY_COMSEN, null, cv349);
        db.insert(KEY_COMSEN, null, cv350);
        db.insert(KEY_COMSEN, null, cv351);
        db.insert(KEY_COMSEN, null, cv352);
        db.insert(KEY_COMSEN, null, cv353);
        db.insert(KEY_COMSEN, null, cv354);
        db.insert(KEY_COMSEN, null, cv355);
        db.insert(KEY_COMSEN, null, cv356);
        db.insert(KEY_COMSEN, null, cv357);
        db.insert(KEY_COMSEN, null, cv358);
        db.insert(KEY_COMSEN, null, cv359);
        db.insert(KEY_COMSEN, null, cv360);
        db.insert(KEY_COMSEN, null, cv361);
        db.insert(KEY_COMSEN, null, cv362);
        db.insert(KEY_COMSEN, null, cv363);
        db.insert(KEY_COMSEN, null, cv364);
        db.insert(KEY_COMSEN, null, cv365);
        db.insert(KEY_COMSEN, null, cv366);
        db.insert(KEY_COMSEN, null, cv367);
        db.insert(KEY_COMSEN, null, cv368);
        db.insert(KEY_COMSEN, null, cv369);
        db.insert(KEY_COMSEN, null, cv370);
        db.insert(KEY_COMSEN, null, cv371);
        db.insert(KEY_COMSEN, null, cv372);
        db.insert(KEY_COMSEN, null, cv373);
        db.insert(KEY_COMSEN, null, cv374);
        db.insert(KEY_COMSEN, null, cv375);
        db.insert(KEY_COMSEN, null, cv376);
        db.insert(KEY_COMSEN, null, cv377);
        db.insert(KEY_COMSEN, null, cv378);
        db.insert(KEY_COMSEN, null, cv379);
        db.insert(KEY_COMSEN, null, cv380);
        db.insert(KEY_COMSEN, null, cv381);
        db.insert(KEY_COMSEN, null, cv382);
        db.insert(KEY_COMSEN, null, cv383);
        db.insert(KEY_COMSEN, null, cv384);
        db.insert(KEY_COMSEN, null, cv385);
        db.insert(KEY_COMSEN, null, cv386);
        db.insert(KEY_COMSEN, null, cv387);
        db.insert(KEY_COMSEN, null, cv388);
        db.insert(KEY_COMSEN, null, cv389);
        db.insert(KEY_COMSEN, null, cv390);
        db.insert(KEY_COMSEN, null, cv391);
        db.insert(KEY_COMSEN, null, cv392);
        db.insert(KEY_COMSEN, null, cv393);
        db.insert(KEY_COMSEN, null, cv394);
        db.insert(KEY_COMSEN, null, cv395);
        db.insert(KEY_COMSEN, null, cv396);
        db.insert(KEY_COMSEN, null, cv397);
        db.insert(KEY_COMSEN, null, cv398);
        db.insert(KEY_COMSEN, null, cv399);
        db.insert(KEY_COMSEN, null, cv400);
        db.insert(KEY_SELWORD, null, cv401);
        db.insert(KEY_SELWORD, null, cv402);
        db.insert(KEY_SELWORD, null, cv403);
        db.insert(KEY_SELWORD, null, cv404);
        db.insert(KEY_SELWORD, null, cv405);
        db.insert(KEY_SELWORD, null, cv406);
        db.insert(KEY_SELWORD, null, cv407);
        db.insert(KEY_SELWORD, null, cv408);
        db.insert(KEY_SELWORD, null, cv409);
        db.insert(KEY_SELWORD, null, cv410);
        db.insert(KEY_SELWORD, null, cv411);
        db.insert(KEY_SELWORD, null, cv412);
        db.insert(KEY_SELWORD, null, cv413);
        db.insert(KEY_SELWORD, null, cv414);
        db.insert(KEY_SELWORD, null, cv415);
        db.insert(KEY_SELWORD, null, cv416);
        db.insert(KEY_SELWORD, null, cv417);
        db.insert(KEY_SELWORD, null, cv418);
        db.insert(KEY_SELWORD, null, cv419);
        db.insert(KEY_SELWORD, null, cv420);
        db.insert(KEY_SELWORD, null, cv421);
        db.insert(KEY_SELWORD, null, cv422);
        db.insert(KEY_SELWORD, null, cv423);
        db.insert(KEY_SELWORD, null, cv424);
        db.insert(KEY_SELWORD, null, cv425);
        db.insert(KEY_SELWORD, null, cv426);
        db.insert(KEY_SELWORD, null, cv427);
        db.insert(KEY_SELWORD, null, cv428);
        db.insert(KEY_SELWORD, null, cv429);
        db.insert(KEY_SELWORD, null, cv430);
        db.insert(KEY_SELWORD, null, cv431);
        db.insert(KEY_SELWORD, null, cv432);
        db.insert(KEY_SELWORD, null, cv433);
        db.insert(KEY_SELWORD, null, cv434);
        db.insert(KEY_SELWORD, null, cv435);
        db.insert(KEY_SELWORD, null, cv436);
        db.insert(KEY_SELWORD, null, cv437);
        db.insert(KEY_SELWORD, null, cv438);
        db.insert(KEY_SELWORD, null, cv439);
        db.insert(KEY_SELWORD, null, cv440);
        db.insert(KEY_SELWORD, null, cv441);
        db.insert(KEY_SELWORD, null, cv442);
        db.insert(KEY_SELWORD, null, cv443);
        db.insert(KEY_SELWORD, null, cv444);
        db.insert(KEY_SELWORD, null, cv445);
        db.insert(KEY_SELWORD, null, cv446);
        db.insert(KEY_SELWORD, null, cv447);
        db.insert(KEY_SELWORD, null, cv448);
        db.insert(KEY_SELWORD, null, cv449);
        db.insert(KEY_SELWORD, null, cv450);
        db.close();
    }
